          ...
          <div className="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul className="nav navbar-toolbar navbar-right navbar-toolbar-right">
              <li className="nav-item">
                <a className="nav-link" role="button" onClick={minimizeWindow} href="">
                  <img src={minimizeWindowIcon} alt="Close" />
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" role="button" onClick={maximizeWindow} href="">
...
function mapDispatchToProps(dispatch) {
  return {
    closeWindow: (e) => { e.preventDefault(); dispatch({ type: Events.EXIT }); },
    maximizeWindow: (e) => { e.preventDefault(); dispatch({ type: Events.WINDOW_MAXIMIZE }); },
    minimizeWindow: (e) => { e.preventDefault(); dispatch({ type: Events.WINDOW_MINIMIZE }); },
  };
}
