      ...
      <div className="panel panel-dark">
        ...
        <div className="panel-body">
          <ul className="nav nav-tabs nav-tabs-line">
            <li className="nav-item"><a className="nav-link active">AniDB</a></li>
            <li className="nav-item"><a className="nav-link">TvDB</a></li>
            <li className="nav-item"><a className="nav-link">MAL</a></li>
          </ul>
